...
export const DocumentImageInserter = () => {
  ...
  const processDocument = async () => {
    if (!wordFile || (beforeImages.length === 0 && afterImages.length === 0)) {
      toast({
        title: "Error",
        description:
          "Por favor selecciona un documento Word y al menos una imagen",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      setProcessingStatus(
        "Insertando comparaciones sin alterar el contenido..."
      );
      ...
      toast({
        title: "Error",
        description:
          (error as Error).message || "Error al procesar el documento",
        variant: "destructive",
      });
      setProcessingStatus("");
    } finally {
  ...
  const downloadDocument = () => {
    ...
    a.href = url;
    a.download = `${
      wordFile?.name?.replace(".docx", "") || "documento"
    }_antes_despues.docx`;
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold text-gray-900">
            Comparador Antes/Después en Word
          </h1>
          <p className="text-gray-600">
            Crea comparaciones visuales lado a lado conservando todo el formato
            original
          </p>
        </div>
        ...
        <Alert className="bg-green-50 border-green-200">
          ...
          <AlertDescription className="text-green-800">
            <strong>Comparaciones automáticas:</strong> Sube las imágenes del
            "antes" y "después" por separado. El programa las organizará
            automáticamente lado a lado manteniendo el orden. Solo se reemplaza
            el marcador{" "}
            <code className="bg-green-100 px-1 rounded">{sectionMarker}</code>{" "}
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Tu documento Word (.docx) donde se insertarán las
                    comparaciones
                  </CardDescription>
                </CardHeader>
                    ...
                    <div className="flex items-center gap-2 p-3 bg-green-50 rounded-lg border border-green-200">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-green-600">
                          Tamaño: {(wordFile.size / 1024).toFixed(1)} KB |
                          Contenido protegido ✓
                        </p>
                      </div>
                    </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Sube las imágenes del estado inicial en el orden deseado
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      <Label htmlFor="before-images">
                        Seleccionar Imágenes del Antes
                      </Label>
                      <Input
                        id="before-images"
                        type="file"
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Sube las imágenes del estado final en el mismo orden
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      <Label htmlFor="after-images">
                        Seleccionar Imágenes del Después
                      </Label>
                      <Input
                        id="after-images"
                        type="file"
            ...
            <div className="space-y-6">
                        ...
                        <div className="flex gap-3">
                          ...
                          <div>
                            <p className="text-sm font-medium">
                              Sube tu documento Word
                            </p>
                            <p className="text-xs text-gray-600">
                              Con el marcador donde quieres las comparaciones
                            </p>
                          </div>
                        </div>
                        <div className="flex gap-3">
                          ...
                          <div>
                            <p className="text-sm font-medium">
                              Sube imágenes del ANTES
                            </p>
                            <p className="text-xs text-gray-600">
                              En el orden que quieres que aparezcan
                            </p>
                          </div>
                        </div>
                        <div className="flex gap-3">
                          ...
                          <div>
                            <p className="text-sm font-medium">
                              Sube imágenes del DESPUÉS
                            </p>
                            <p className="text-xs text-gray-600">
                              En el mismo orden que las del antes
                            </p>
                          </div>
                        </div>
                        <div className="flex gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-600">
                              Se crearán las comparaciones automáticamente
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <Alert className="bg-yellow-50 border-yellow-200">
                <AlertDescription className="text-yellow-800">
                  <strong>Consejo importante:</strong> Asegúrate de subir las
                  imágenes en el mismo orden en ambos grupos. La primera imagen
                  del "antes" se emparejará con la primera del "después", y así
                  sucesivamente.
                </AlertDescription>
              </Alert>
            </div>
